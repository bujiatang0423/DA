...
export function PositionCorrectionForm({ page, pending, onCancel, onSubmit }: Props): JSX.Element {
    const [reason, setReason] = useState("");
    const [quantities, setQuantities] = useState<Record<string, string>>(
        Object.fromEntries(page.items.map((item) => [item.security_id, String(item.quantity)])),
    );
    return (
        <form
        ...
        >
            ...
            <div className="inline-actions">
                <button className="btn" disabled={pending} type="submit">确认人工校正</button>
