...
export interface CandidateItem { security_id: string; security_name?: string; bucket: string; state?: string; percentile_rank?: number; factors?: Record<string, number>; planned_quantity?: number; initial_stop?: string | number | null; trigger_condition?: string; invalidation_condition?: string; reason_codes?: string[]; quality_codes?: string[] }
